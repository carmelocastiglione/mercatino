...
@section('dashboard-content')
    ...
    <div class="mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-900 mb-2">Nuovo Annuncio</h1>
        <p class="text-gray-600">Crea una nuova copia di un libro in vendita</p>
    </div>

    <!-- Form -->
    <div class="max-w-3xl bg-white rounded-lg shadow p-8">
        <form method="POST" action="{{ route('admin.listings.store') }}" class="space-y-6">
            @csrf
