...
@section('title', 'Aggiungi Libro al Catalogo')

@section('content')
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-900">Aggiungi Libro al Catalogo</h1>
        <p class="text-gray-600 mt-2">Inserisci i dati del nuovo libro</p>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 max-w-3xl">
        <form action="{{ route('staff.books.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input 
                    ...
                    name="title" 
                    value="{{ old('title') }}"
                    placeholder="Es: Harry Potter e la pietra filosofale"
            ...
            <div>
                ...
                <textarea 
                    ...
                    name="description" 
                    rows="4"
                    placeholder="Inserisci una breve descrizione del libro (opzionale)"
