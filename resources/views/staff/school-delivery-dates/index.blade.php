...
@section('content')
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Date di Consegna</h1>
            ...
            <div class="col-span-3">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('staff.delivery-dates.create') }}" class="px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition">
                            Aggiungi Data
                        </a>
                    </div>
