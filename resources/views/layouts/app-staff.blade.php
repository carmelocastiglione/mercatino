    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="sidebar fixed lg:relative left-0 top-0 h-screen lg:h-auto w-64 bg-white border-r border-gray-200 flex flex-col transform transition-transform duration-300 ease-in-out z-40">
            ...
            <nav class="flex-1 p-6 space-y-1 overflow-y-auto">
                ...
                <!-- Riscossioni -->
                <a href="{{ route('staff.withdrawals.index') }}" class="block px-4 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 transition @if(request()->is('staff/withdrawals*')) bg-gray-100 text-gray-900 @endif">
                    Riscossioni
                </a>
                ...
                <!-- Impostazioni -->
                <a href="{{ route('staff.settings.general') }}" class="block px-4 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 transition @if(request()->is('staff/settings*')) bg-gray-100 text-gray-900 @endif">
                    Impostazioni
                </a>

                <!-- Segnala Problema -->
                <a href="{{ route('staff.problems.create') }}" class="block px-4 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 transition">
                    Segnala problema
                </a>
            </nav>
