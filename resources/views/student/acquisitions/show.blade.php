    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-col md:flex-row gap-2 print:hidden">
                ...
                <a href="{{ route('student.book-listings.index') }}" class="px-6 py-3 bg-gray-600 text-white font-medium rounded-lg hover:bg-gray-700 transition text-center">
                    Torna ai miei libri
                </a>
            </div>
        </div>
        ...
        <div class="space-y-8">
            ...
            <x-information-note message="L'acquisizione è stata registrata correttamente. Stampa questo riepilogo e consegnalo come ricevuta." />
            ...
            <div class="flex gap-4 print:hidden">
                <a href="{{ route('student.book-listings.index') }}" class="flex-1 px-6 py-4 bg-gray-600 text-white font-medium rounded-lg hover:bg-gray-700 transition text-center">
                    Torna ai miei libri
                </a>
