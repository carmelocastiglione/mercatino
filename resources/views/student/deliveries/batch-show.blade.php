...
@section('title', 'Riepilogo Prenotazione Consegna')
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-col md:flex-row gap-2 print:hidden">
                ...
                <a href="{{ route('student.deliveries.index') }}" class="px-6 py-3 bg-gray-600 text-white font-medium rounded-lg hover:bg-gray-700 transition text-center">
                    Torna alle consegne
                </a>
            </div>
        </div>
        ...
        <script>
            function handlePrint() {
                ...
                printWindow.document.write(`
                    ...
                    <head>
                        <meta charset="UTF-8">
                        <title>Riepilogo Prenotazione Consegna</title>
