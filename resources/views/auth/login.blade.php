...
@section('content')
    <!-- Login Section -->
    <section class="min-h-screen bg-gray-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full">
            ...
            <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex flex-col items-center text-center">
                    <div>
                        <p class="text-sm font-medium text-blue-800">Accesso Google disponibile solo per</p>
                        <p class="text-sm font-medium text-blue-800 mt-1">account con dominio <span class="font-semibold">@issvigano.org</span></p>
                    </div>
                </div>
            </div>

            <!-- Google SSO Button -->
            <a href="{{ route('google.redirect') }}" class="w-full mb-6 bg-white border-2 border-gray-300 text-gray-700 font-semibold py-3 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition duration-200 flex items-center justify-center gap-2">
