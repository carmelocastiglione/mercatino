        ...
        <table class="w-full">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-sm font-semibold text-gray-900">Codice Venditore</th>
                    <th class="px-6 py-4 text-right text-sm font-semibold text-gray-900">Prezzo</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-200">
                @forelse($batch->sales as $index => $sale)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">
                            {{ $sale->bookListing->book->isbn ?? 'N/A' }}
                        </td>
