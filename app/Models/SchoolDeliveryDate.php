...
class SchoolDeliveryDate extends Model
{
    /**
    ...
    /**
     * Get the school this delivery date belongs to.
     */
    ...
    /**
     * Get the delivery batches for this date.
     */
    public function deliveryBatches(): HasMany
    {
        return $this->hasMany(BookDeliveryBatch::class, 'scheduled_delivery_date_id');
    }
